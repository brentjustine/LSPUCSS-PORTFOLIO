...
async def generate_suggestions(
    ...
    file_paths: List[Union[str, Dict[str, str]]] | None = None,
    grade: float | None = None
) -> str:
    """
    Generate AI suggestions for a project.
    - Uses the grade from the project dict if no grade is provided.
    - Uses description and file_paths from the project dict if not provided.
    """
